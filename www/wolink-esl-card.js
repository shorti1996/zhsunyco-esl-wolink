          ...
          <div class="dropdowns">
            <div class="dropdown-group">
              <ha-select
                ...
                @selected=${this._onBackgroundChange}
            ...
            <div class="dropdown-group">
              <ha-select
                ...
                @selected=${this._onRotationChange}
                @closed=${t=>t.stopPropagation()}
              >
                ${lt(ct)}
              </ha-select>
